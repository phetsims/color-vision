...
(4) Open in the browser: `http://localhost/color-vision/color-vision_en.html`
...
(3) Open in the
browser: `http://localhost/color-vision/build/adapted-from-phet/color-vision_en_adapted-from-phet.html`
