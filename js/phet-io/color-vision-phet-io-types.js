...
window.phet.phetio.phetioTypes = assert &&
  {
    ...
    "FunctionIO.(ColorIO)=>VoidIO": {
      ...
      "supertype": "ParametricTypeIO.<ColorIO, VoidIO>",
    ...
    "FunctionIO.(ColorIO,NullableIO.<ColorIO>)=>VoidIO": {
      ...
      "supertype": "ParametricTypeIO.<ColorIO, NullableIO.<ColorIO>, VoidIO>",
    ...
    "NullableIO.<ColorIO>": {
      ...
      "supertype": "ParametricTypeIO.<ColorIO>",
    ...
    "ParametricTypeIO.<ColorIO, NullableIO.<ColorIO>, VoidIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeIO.<ColorIO, NullableIO.<ColorIO>, VoidIO>"
    },
    "ParametricTypeIO.<ColorIO, VoidIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeIO.<ColorIO, VoidIO>"
    },
    "ParametricTypeIO.<ColorIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeIO.<ColorIO>"
    },
